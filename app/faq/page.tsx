...
const faqs = [
  ["What is the minimum order?", "Checkout unlocks when cart subtotal reaches Rs 5,000 before GST and delivery. Delivery is free above Rs 10,000 subtotal within 14 km from Mayur Vihar Phase 2, Delhi."],
